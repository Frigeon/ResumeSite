...
define('LOGOUT_URL', 'http://jonathanhalls.gralindfarms.com/index.html');
...
<html>
<head>
  <title>Online Portfolio of Jonathan Halls - Please enter password to access this page</title>
...
<section>
	<div id="resume">
		...
		<address>#1 &#45; 1825 Tranquille Rd<br/>Kamloops, BC<br/>V2B 3M2<br/>(250)574-5039<br/><a href="mailto:jhalls@shaw.ca">jhalls@shaw.ca</a>
		</address><br />
		<article>
  <style>
...
<?php if (USE_USERNAME) echo 'Login:<br /><input type="input" name="access_login" /><br />Password:<br />'; ?>
  ...
  <br />
  <a style="font-size:9px; color: #000000; font-family: Verdana, Arial;" href="http://www.zubrag.com/scripts/password-protect.php" title="Download Password Protector">Powered by Password Protect</a>
  </div>
</body>
</html>
